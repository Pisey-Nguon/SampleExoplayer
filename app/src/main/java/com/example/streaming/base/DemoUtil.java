...
import com.example.streaming.BuildConfig;
import com.example.streaming.streamcomponentonline.DownloadTracker;
...
public final class DemoUtil {
  ...
  private static @MonotonicNonNull
  StreamNT downloadNotificationHelper;
  ...
  public static synchronized StreamNT getDownloadNotificationHelper(
      Context context) {
    if (downloadNotificationHelper == null) {
      downloadNotificationHelper =
          new StreamNT(context, DOWNLOAD_NOTIFICATION_CHANNEL_ID);
    }
